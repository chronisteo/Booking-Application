...
/**
 * This class represents a single room,that specifies a category of the hotel room.
 * Extends from HotelRoom
 */
public class SingleRoom extends HotelRoom implements Serializable {
    /**
     * This constructor initializes the single room with the given parameters
     *
     ...
     */
    public SingleRoom(String providerName, String hotelName, int m2, int price, boolean nonSmoking, boolean balcony, boolean tv){
