...
public class HotelOwnerDialog extends JDialog {
    private final ArrayList<User> users;
    private final HotelOwner loginuser;

    public HotelOwnerDialog(LoginDialog login, boolean modality){
        super(login,"Menu",modality);
        users= login.getUsers();
        loginuser=(HotelOwner) login.getLoginuser();
        ...
        JMenuItem add = new JMenuItem("Add a hotel");
        ...
        JMenuItem remove = new JMenuItem("Remove a hotel");
        remove.addActionListener(e -> {
            openRemoveHotelDialog();
            try(ObjectOutputStream oos=new ObjectOutputStream(new FileOutputStream("myfile.bin"))){
                oos.writeObject(users);
            }catch (IOException t){
                t.printStackTrace();
        ...
        JMenuItem hotels = new JMenuItem("SHOW HOTELS");
        hotels.addActionListener(e -> openHotelsDialog());
    ...
    public HotelOwner getLoginUser(){
        return loginuser;
    }
    public void openHotelsDialog(){
         new HotelsDialog(this, true);
    }
    public void openMessagesDialog(){
         new MessagesDialog(this, true);
    }
    public void openCancellationsDialog(){
         new CancellationsDialog(this, true);
    }
    public void openReservationsDialog(){
         new ReservationsDialog(this, true);
    }
    public void openAddHotelDialog(){
         new AddHotelDialog(this, true);
    }
    public void openRemoveHotelDialog(){
         new RemoveHotelDialog(this, true);
    }
