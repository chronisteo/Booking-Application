 ...
 */
public class DoubleRoom extends HotelRoom implements Serializable {
    /**
     * This constructor initializes the double room with the given parameters
     *
     ...
     */
    public DoubleRoom(String providerName, String hotelName, int m2, int price, boolean nonSmoking, boolean balcony, boolean tv){
